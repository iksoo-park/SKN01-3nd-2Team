...
<div align="left">    
    <div>
        <strong>[ATTENTION PROJECT] ➡️ AI 기반 이상형 매칭 서비스</strong><br><br>
        마음에 드는 사람을 만날 기회가 줄어들고 연애를 하기가 어려워지는 사회 분위기 속에서,<br>
        자신이 어떤 유형의 연애 상대를 원하는지 기준을 세우기조차 쉽지 않은 상황입니다.<br>
        [ATTENTION PROJECT]는 AI 기반 이상형 매칭 서비스입니다.<br>
        어텐션팀은 사용자에게 다양한 유형의 AI 이성과의 소개팅 경험을 제공하고,<br>
        이상형을 정립할 수 있는 서비스를 제공하고자 합니다.<br>
    </div>
</div>
